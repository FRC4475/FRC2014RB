...
public class OI {
    ...
    public Joystick shooterJoystick2;
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public OI() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        shooterJoystick2 = new Joystick(2);
        ...
        SmartDashboard.putData("ShotBallHighPower", new ShotBallHighPower());
    ...
    public Joystick getShooterJoystick2() {
        return shooterJoystick2;
    }
